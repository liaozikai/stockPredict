...
class DoubleAdapt(ForecastModel):
    def __init__(
        ...
        allParameters = list(self.teacher_x.parameters()) + list(self.teacher_y.parameters()) + list(self.model.parameters())

        print("===================model size=================================")
        print("model size(MB):", count_parameters(allParameters))
